...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/routers.MemoryMatrixResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request"
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routers.UserUpdateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "routers.RegisterRequest": {
            ...
            "properties": {
                "password": {
                    "description": "Password 至少 6 个字符，UTF-8 编码后不能超过 72 字节",
                    "type": "string",
                    "minLength": 6
                },
                "username": {
                    "description": "Username 去除首尾空白后为 3 到 50 个字符",
                    "type": "string",
                    "maxLength": 50,
                    "minLength": 3
                }
